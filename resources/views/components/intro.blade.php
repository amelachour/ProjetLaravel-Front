        ...
        <div class="column lg-12 s-intro__content-inner">
            <div class="s-intro__content-left">
                <h1 class="s-intro__content-title">
                    Recyclez aujourd'hui, <br>
                    Sauvez demain.
                </h1>
            </div>
            <div class="s-intro__content-right">
                <p class="s-intro__content-desc body-text-2">
                    Découvrez comment notre application vous aide à localiser facilement les centres de recyclage et à en savoir plus sur les matériaux que vous pouvez recycler.
                    Ensemble, nous pouvons construire un avenir durable !
                </p>

                <div class="s-intro__content-buttons">
                    <a href="#download" class="btn btn--primary s-intro__content-btn smoothscroll">Commencer</a>

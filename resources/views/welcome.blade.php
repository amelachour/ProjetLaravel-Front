                ...
                <div class="row s-intro__content">
                    ...
                    <div class="column lg-12 s-intro__content-inner">
                        ...
                        <div class="s-intro__content-right">
                            ...
                            Discover how our app helps you easily locate recycling centers and learn more about the materials you can recycle. 
                ...
                <div class="s-about__info">
                    ...
                    <div class="row section-header" data-num="01">
                        ...
                        <div class="column lg-6 stack-on-1000 desc-block">
                                            ...
                                            Track your recycling efforts, discover nearby recycling centers, and contribute to a cleaner planet.
                                        </p>
                        ...
                        <div class="column lg-12">
                            ...
                            <div class="swiper-container s-about__info-slider">
                                ...
                                <div class="s-about__info-slide swiper-slide">
                                        ...
                                        <p>
                                            Our platform encourages responsible waste disposal, helping communities reduce their environmental footprint through recycling initiatives.
                                        </p>
                                    </div>
                                    <div class="s-about__info-slide swiper-slide">
                                        <h4 class="h5">Easy to Use.</h4>
                                        <p>
                                            Locate recycling centers, track your recycling activity, and stay informed on waste management tips with just a few clicks.
                                        </p>
                                    </div>
                                    <div class="s-about__info-slide swiper-slide">
                                        <h4 class="h5">Community Impact.</h4>
                                        <p>
                                            Join a network of environmentally conscious individuals and organizations working together to reduce waste and promote sustainability.
                                        </p>
                                    </div>
                                    <div class="s-about__info-slide swiper-slide">
                                        <h4 class="h5">Secure & Reliable.</h4>
                                        <p>
                                            Your data is securely stored, ensuring that your personal information and environmental contributions are protected.
                                        </p>
                                    </div>
                    ...
                    <div class="row s-about__howto-content">
                        ...
                        <div class="column s-about__howto-process-block">
                            ...
                            <div class="s-about__howto-process-step">
                                        ...
                                        <p>
                                            Create an account to start tracking your waste management activities and accessing recycling centers nearby.
                                        </p>
                                    </div>
                                    <div class="s-about__howto-process-step">
                                        <h3 class="h5">Locate Centers</h3>
                                        <p>
                                            Use our map to find certified recycling centers and waste management facilities in your area.
                                        </p>
                                    </div>
                                    <div class="s-about__howto-process-step">
                                        <h3 class="h5">Track Recycling</h3>
                                        <p>
                                            Record the materials you've recycled and see the positive impact you're making on the environment.
                                        </p>
                                    </div>
                                    <div class="s-about__howto-process-step">
                                        <h3 class="h5">Make a Difference</h3>
                                        <p>
                                            Join a global community contributing to a cleaner, greener planet by reducing waste and promoting recycling.
                                        </p>
                                    </div>
                        ...
                        <div class="column s-about__howto-screens-block">
                            ...
                            <div class="s-about__howto-screens">
                                <img src="images/co.jpg"
                                     srcset="images/co.jpg 1x, images/co.jpg 2x" alt="">
                                <img src="images/co.png.jpg"
                                     srcset="images/co.jpg 1x, images/co.jpg 2x" alt="">
                            </div>
...
<div class="row narrow text-center s-testimonials__header">
    <div class="column lg-12">
        <h3 class="h2">Ce Que Nos Utilisateurs Disent.</h3>
    </div>
</div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="s-testimonials__slide swiper-slide">
                    <div class="s-testimonials__author">
                        ...
                        <cite class="s-testimonials__cite">
                            ...
                            <span>Activiste Écologique</span>
                        </cite>
                    </div>
                    <p>
                        "Ce site m'a aidé à trouver des centres de recyclage près de chez moi. 
                        Grâce à elle, je suis plus consciente de l'importance du recyclage dans notre quotidien."
                    </p>
                ...
                <div class="s-testimonials__slide swiper-slide">
                    <div class="s-testimonials__author">
                        ...
                        <cite class="s-testimonials__cite">
                            <strong>Jean-Pierre Martin</strong>
                            <span>Responsable d'Association</span>
                        </cite>
                    </div>
                    <p>
                        "ce site facilite le recyclage. Nous avons pu organiser des événements de collecte de déchets grâce à ses fonctionnalités."
                    </p>
                </div> <!-- end s-testimonials__slide -->
                ...
                <div class="s-testimonials__slide swiper-slide">
                    <div class="s-testimonials__author">
                        ...
                        <cite class="s-testimonials__cite">
                            <strong>Audrey Lefevre</strong>
                            <span>Consommatrice Responsable</span>
                        </cite>
                    </div>
                    <p>
                        "Une plateforme indispensable pour ceux qui souhaitent agir pour l'environnement. 
                        Chaque geste compte et cette application le rend facile."
                    </p>
                </div> <!-- end s-testimonials__slide -->

                <div class="s-testimonials__slide swiper-slide">
                    <div class="s-testimonials__author">
                        <img src="images/avatars/user-04.jpg" alt="Author image" class="s-testimonials__avatar">
                        <cite class="s-testimonials__cite">
                            <strong>Paul Moreau</strong>
                            <span>Éducateur Environnemental</span>
                        </cite>
                    </div>
                    <p>
                        "Je recommande ce site web à tous mes élèves ! Elle les motive à recycler et à comprendre l'impact de leurs choix."
                    </p>
                </div> <!-- end s-testimonials__slide -->
            ...
            Every small action helps protect our planet!
                ...
                <div class="column lg-6 stack-on-900 end">
                    <ul class="s-footer__site-links">
                        <li><a class="smoothscroll" href="#home" title="intro">Company</a></li>
                        <li><a class="smoothscroll" href="#about" title="about">About Us</a></li>
                        <li><a class="smoothscroll" href="#testimonials" title="reviews">Contact</a></li>
                        <li><a class="smoothscroll" href="#pricing" title="pricing">Careers</a></li>
                        <li><a class="smoothscroll" href="#download" title="download">FAQ</a></li>	
                    </ul>
